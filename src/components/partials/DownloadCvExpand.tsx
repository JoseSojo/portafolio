...
export const DownloadCvExpand = () => {

    return (
        <>
            <div className="relative duration-500 [transform:rotate3d(20_,-10,_1,_60deg)]  hover:-rotate-0  group border-sky-900 border-4  overflow-hidden rounded-2xl h-72 w-96 bg-sky-800 p-5 flex flex-col items-start gap-4">
                <div className="text-gray-50">
                    <span className="font-bold text-5xl">José Sojo</span>
                    <p className="text-xs mt-5">Web Developer</p>
                </div>
                <a href={CV} download className="duration-300 hover:bg-sky-900 border hover:text-gray-50 bg-gray-50 font-semibold text-sky-800 px-3 py-2 flex flex-row items-center gap-3">Dowload CV 
